...
KUBE_PS1_FIX_COLOR="${KUBE_PS1_FIX_COLOR}"
...
kube_ps1() {
  ...
  # Prefix
  [[ -n "${KUBE_PS1_PREFIX}" ]] && KUBE_PS1+="$(_kube_ps1_color_fg $KUBE_PS1_FIX_COLOR)${KUBE_PS1_PREFIX}${KUBE_PS1_RESET_COLOR}"
  ...
  # Context
  KUBE_PS1+="$(_kube_ps1_color_fg $KUBE_PS1_CTX_COLOR)${KUBE_CONTEXT:-$KUBE_PS1_CONTEXT}${KUBE_PS1_RESET_COLOR}"
  ...
  if [[ "${KUBE_PS1_NS_ENABLE}" == true ]]; then
    ...
    KUBE_PS1+="$(_kube_ps1_color_fg ${KUBE_PS1_NS_COLOR})${KUBE_NAMESPACE:-$KUBE_PS1_NAMESPACE}${KUBE_PS1_RESET_COLOR}"
  fi

  # Suffix
  [[ -n "${KUBE_PS1_SUFFIX}" ]] && KUBE_PS1+="$(_kube_ps1_color_fg $KUBE_PS1_FIX_COLOR)${KUBE_PS1_SUFFIX}${KUBE_PS1_RESET_COLOR}"
